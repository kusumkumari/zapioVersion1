...
export const API_BASEURL_IMG = "http://192.168.0.104:1234/media/import/customer_register.xls"

// export const API_BASEURL_IMG =
//   "https://zapio-admin.com/media/import/customer_register.xls";
...
export const listCategoriesAPI = (status, callback) => {
...
export const listProductAPI = (payload, callback) => {
...
export const addProductAPI = (
  ...
  for (let i = 0; i < fileData.length; i++) {
    formData.append("image" + i, fileData[i]);
  }
  ...
  formData.append("kot_desc", kot_discrp);
  formData.append("has_variant", hasVariant);
  formData.append("tax_association", JSON.stringify(taxArray));
  formData.append("is_recommended", recommend);
  formData.append("included_platform", JSON.stringify(aggregatorArray));
  axios
    .post(url, formData, {
      headers: {
        Authorization: "Token " + localStorage.getItem("token"),
...
export const listCustomerAPI = (page, callback) => {
  const pages = page;
  console.log(pages);
  let url = `${API_BASE_URL}/Customer/All/listing/?page=${pages}`;
  axios
    .get(url, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const addBrandDeliveryBoyAPI = (
  id,
  name,
  email,
  mobile,
  ...
  let url = `${API_BASE_URL}/deliveryboy/create_update/`;
  axios
    .post(url, formData, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const listDeliveryBoyAPI = callback => {
  ...
  if (localStorage.getItem("usertype") == "is_outlet")
    url = `${API_BASE_URL}/outlet/deliveryboy/listdata/`;
  else url = `${API_BASE_URL}/deliveryboy/list/`;
...
export const retriveDeliveryBoyAPI = (id, callback) => {
  let url = "";
  if (localStorage.getItem("usertype") == "is_outlet")
    url = `${API_BASE_URL}/outlet/retrieval_data/delivery_boy/`;
  else url = `${API_BASE_URL}/deliveryboy/retrieve/`;
  axios
    .post(
      url,
      { id: id.toString() },
...
export const changeDeliveryBoyStatusAPI = (id, status, callback) => {
  let url = "";
  if (localStorage.getItem("usertype") == "is_outlet")
    url = `${API_BASE_URL}/outlet/action/DeliveryBoy/`;
  else url = `${API_BASE_URL}/deliveryboy/action/`;
...
// };
export const addTimingAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/v2/create_update/Openingtiming/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const addFoodProcessAPI = (
  id,
  products,
  variants,
  stepNo,
...
export const listPosOrdersAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/BrandPos/listfilter/orders/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const getPosOrdersAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/BrandPos/retrieval/order/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const syncOutletsAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/UrbanPiper/sync/outlet/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const listUnInitatedOutletsAPI = callback => {
  let url = `${API_BASE_URL}/UrbanPiper/listing/not_initiated_outlet/`;
  axios
    .get(url, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const listSyncedOutletsAPI = callback => {
  let url = `${API_BASE_URL}/UrbanPiper/listing/outlet/`;
  axios
    .get(url, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const getAttachedOutletsAPI = callback => {
  let url = `${API_BASE_URL}/UrbanPiper/attach/outlet/`;
  axios
    .get(url, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const listActiveCouponAPI = callback => {
  let url = `${API_BASE_URL}/emailsetting/coupon/`;
  axios
    .get(url, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const orderEmailListAPI = callback => {
  let url = `${API_BASE_URL}/emailsetting/setting/`;
  axios
    .get(url, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const AddOrderEmailDetailAPI = (
  ...
  let url = `${API_BASE_URL}/emailsetting/edit/`;
  axios
    .post(url, formData, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const changeOrderEmailStatusAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/emailsetting/action/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const uploadExcelFormatAPI = (file, callback) => {
  ...
  let url = `${API_BASE_URL}/customer/import/`;
  axios
    .post(url, formData, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const changeOutletSyncStatusAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/UrbanPiper/action/outlet/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const listSunchedOutlts = callback => {
  let url = `${API_BASE_URL}/UrbanPiper/listing/synced_outlet/`;
  axios
    .get(url, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const listMenuCategoryAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/UrbanPiper/listing/category/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const listMenuProductsAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/UrbanPiper/listing/product/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const attachMenuCategoryAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/UrbanPiper/attach/category/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const attachMenuProductAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/UrbanPiper/attach/products/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const betweenFoodProcessAPI = (
  id,
  products,
  variants,
  afterStep,
  ...
  formData.append("product", products);
  formData.append("varient", variants);
  formData.append("after_step", afterStep);
  formData.append("process", stepName);
  formData.append("description", stepDiscrp);
  formData.append("time_of_process", stepTime);
  formData.append("ingrediate", JSON.stringify(ingArray));
  let url = `${API_BASE_URL}/kitchen/processStep/between/`;
  axios
    .post(url, formData, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const initiateMenuSyncAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/UrbanPiper/sync/menu/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const downloadPosCSVAPI = callback => {
  let url = `${API_BASE_URL}/front/pos/csv/`;
  axios
    .get(url, {
      headers: {
        Authorization: "Token " + localStorage.getItem("token")
...
export const AddDiscountAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/discount/create_update/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const listDiscountPercAPI = callback => {
  let url = `${API_BASE_URL}/discount/list/`;
  axios
    .get(url, {
      headers: {
        Authorization: "Token " + localStorage.getItem("token")
...
export const getDiscountAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/discount/retrieve/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const changeDiscountPercnStatusAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/discount/action/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const listReasonsAPI = callback => {
  let url = `${API_BASE_URL}/reason/list/`;
  axios
    .get(url, {
      headers: {
        Authorization: "Token " + localStorage.getItem("token")
...
export const AddReasonAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/reason/createupdate_data/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const getReasonAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/reason/retrieve/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const changeReasonStatusAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/reason/action/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const listCatWiseProductAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/filterlisting/multiplecategory/product/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const listProReportAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/product/report/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const listAddonReportAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/addon/report/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const listPerrmissionAPI = (callback) => {
  let url = `${API_BASE_URL}/UserRoll/allmenu/`;
  axios
    .get(url, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const AddPermissionAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/UserRoll/savepermission/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const listBillPerrmissionAPI = (callback) => {
  let url = `${API_BASE_URL}/UserRoll/bill/allmenu/`;
  axios
    .get(url, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const AddBillPermissionAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/UserRoll/bill/savepermission/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const listPaymentReportAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/ordermgnt/payment/report/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const listReportOutletAPI = (callback) => {
  let url = `${API_BASE_URL}/ordermgnt/outlet/`;
  axios
    .get(url, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const listActiveTaxAPI = (callback) => {
  let url = `${API_BASE_URL}/Taxes/activetax/listing/`;
  axios
    .get(url, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const listReceivedCOnfigurationAPI = (callback) => {
  let url = `${API_BASE_URL}/receive/list/`;
  axios
    .post(url, {}, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const addReceivedCOnfigurationAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/receive/createupdate_data/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const retrieveReceivedConfigHandlerAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/receive/retrieve/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const changeReceivedConfigStatusAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/receive/action/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const orderAllStatusAPI = (callback) => {
  let url = `${API_BASE_URL}/order/allstatus/`;
  axios
    .get(url, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const listOrdersReterieveAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/order/retrieve/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const listOrderEditAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/order/edit/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const downloadRatingCSVAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/ordermgnt/ratingcsv/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") },
...
export const uploadRatingExcelFormatAPI = (file, callback) => {
  ...
  let url = `${API_BASE_URL}/ordermgnt/ratingcsv/upload/`;
  axios
    .post(url, formData, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const lstOutletLogsAPI = (payload, callback) => {
  let url = `${API_BASE_URL}/ordermgnt/log/`;
  axios
    .post(url, payload, {
      headers: { Authorization: "Token " + localStorage.getItem("token") }
    })
...
export const addCategoryAPI = (id, name, code, priority, formdata, category_desc, companyId1, callback) => {
  let url = `${API_BASE_URL}/createupdate_data/catagory/`;
  const formData = new FormData();
  if (id == "add") {
...
export const addOutletAPI = (username, password, Outletname, address, longitude, latitude, city, area, formdata, companyId1, callback) => {
  let url = `${API_BASE_URL}/brand_outlet/outlet_creation/`;
  const formData = new FormData();
  formData.append("outlet_image", formdata);
...
export const updateSubcategoryAPI = (id, category, subcategory_name, description, formdata, callback) => {
