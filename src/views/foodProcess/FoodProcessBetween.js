...
export default class FoodProcessBetween extends Component {
  constructor() {
    super();
  ...
  render() {
    ...
    return (
      <Modal isOpen={this.props.isBetweenFormOpen}>
        <ModalHeader className="flexboxes" toggle={this.props.cancel}>
          ...
          &nbsp;
          <IntlMessages id="food.between-food-preparation-process" />
        </ModalHeader>
        <ModalBody>
          <Card className="entry">
            <CardBody>
              ...
              <FormGroup row>
                <Label sm="4">
                  <IntlMessages id="food.after-step" />
                </Label>
                <Colxx sm="8">
                  <Input
                    type="number"
                    name="afterStep"
                    value={this.props.afterStep}
              ...
              <Button
                ...
                onClick={this.props.betweenFoodProcessHandler}
              >
