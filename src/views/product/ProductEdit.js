...
import {
  ...
  Button,
  Input,
  CustomInput, Modal, ModalBody, ModalHeader,
} from "reactstrap";
...
export default class ProductEdit extends Component {
  render() {
    const { categorydata, tagData, tagDataLength, categoryLength, SubCatdata, SubCatdataLength, addOndata,
      addOndataLength, variantdata, variantdataLength, fooddata, fooddataLength, taxdata, taxdataLength, onChangeHandler, shiftRight, shiftLeft, deleteImage } = this.props;
    const tagOptions = [];
    const subCatOptions = [];
    const CatOptions = [];
    const addOnptions = [];
    ...
    const ImagePreview = (props) => {
      const imageStyle = { height: "100px", width: "170px" };
    ...
    return (
      ...
      >
        <ModalHeader className="flexboxes" toggle={this.props.cancel}>
          ...
          <IntlMessages id='product.edit-product' />
            ...
            <CardBody>
              ...
              <FormGroup row>
                <div style={{ display: "flex" }}>
                  ...
                  {this.props.file && this.props.file.map((el, index) => (
                    <ImagePreview
                      image={el}
                      index={index}
                      key={index}
              ...
              <FormGroup row style={{ display: this.props.priceVisibilty }}>
                ...
                <Colxx sm="8">
                  <Input type="number" value={this.props.price} name="price" onChange={this.props.handleChangeText} />
                </Colxx>
              </FormGroup>
              <FormGroup row style={{ display: this.props.priceVisibilty }}>
                <Label sm="4">
              ...
              <Button variant="contained"
                ...
                style={{ borderRadius: 5 }} onClick={(e) => { this.props.editProductHandler(this.props.id) }}>
