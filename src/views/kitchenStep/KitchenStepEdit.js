...
export default class KitchenStepEdit extends Component {
  render() {
    const { fooddata, fooddataLength, editStepsHandler } = this.props;
      ...
      <Modal isOpen={this.props.isEdit}>
        <ModalHeader className="flexboxes" toggle={this.props.cancel}>
          <Avatar aria-label="recipe" style={{ backgroundColor: "black" }}>
            <i
              className="iconsminds-chopsticks"
              style={{ fontSize: "xx-large" }}
            />
          </Avatar>
          &nbsp;
          <IntlMessages id="edit.kitchen-step" />
        </ModalHeader>
        <ModalBody>
          <Card>
            <CardBody>
