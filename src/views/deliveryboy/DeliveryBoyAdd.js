...
export default class DeliveryBoyAdd extends Component {
  render() {
    const {
    ...
    console.log("uuuuuuuuuuuuuuu", OutletOptions);
    ...
    return (
      <Modal isOpen={this.props.isFormOpen}>
        <ModalHeader className="flexboxes" toggle={this.props.cancel}>
          ...
          &nbsp;
          <IntlMessages id="add.delivery-boy-management" />
        </ModalHeader>
        <ModalBody>
          <Card>
            <CardBody>
              <Form className="dashboard-quick-post">
                ...
                <Button
                  ...
                  onClick={
                    userType() == "is_outlet"
                      ? addDeliveryBoyHandler
                      : this.props.addBrandDeliveryBoyHandler
                  }
                >
